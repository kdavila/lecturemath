...
class Labeler:
    ...
    accessmath_lib = ctypes.CDLL(os.path.abspath('./accessmath_lib.so'))
    ...
    #========================================================================
    @staticmethod
    def extractConnectedComponentsPython(content, filter_small=True):
        print("WARNING: Deprecated function extractConnectedComponentsPython")
    ...
    # =======================================================================================
    # Label and extract connected components from a binary image without temporal information
    # =======================================================================================
    @staticmethod
    def extractConnectedComponents(content, filter_small=True, is_labeled=False):
        fake_age = np.zeros(content.shape, dtype=np.float32)
        current_cc = Labeler.extractSpatioTemporalContent(content, fake_age, filter_small, is_labeled)
    ...
    #========================================================================
    @staticmethod
    def extractSpatioTemporalContent(content, ages, filter_small=True, is_labeled=False):
        ...
        if not is_labeled:
            ...
            # content is given as pre-labeled CCs ...
            labels = content
            count_labels = labels.max()
